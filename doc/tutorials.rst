...
:isotopic_inchi: Isotopic inchi of the corresponding tracer isotopologue (or just the isotopic layer if no InChI has been provided in the :ref:`Metabolites database`); e.g. 'XXX' for the MXXXX 13C-isotopologue of fumarate.
