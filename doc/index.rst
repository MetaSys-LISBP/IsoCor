...
The code is open-source, and available on GitHub under a :ref:`GPLv3 license <license>`.
This documentation can also be found online at `Read the Docs <https://isocor.readthedocs.io/en/latest/>`_.
